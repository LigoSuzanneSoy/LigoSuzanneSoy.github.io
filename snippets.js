{
  "snippets": {
    ...
    "proof_max-header": [
      ...
      "",
      "(*",
      "Compute fold_left u_max                      [ Bid 1; Bid 2; Bid 3; Claim ] (Bid 0).",
      "Compute fold_left u_max                      [ Bid 1; Bid 2; Bid 3; Claim; Bid 4 ] (Bid 0).",
      "Compute fold_left u_max (valid_ops Available [ Bid 1; Bid 2; Bid 3; Claim; Bid 4 ]) (Bid 0).",
      "*)",
      "",
      "Lemma fold_get_bids :",
      "  forall l z,",
