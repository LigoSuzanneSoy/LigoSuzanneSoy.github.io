{
  "snippets": {
    ...
    "lemma_fold_invariant_aux-lemma-signature": [
    ...
    "lemma_fold_invariant_aux-lemma-proof": [
      "intros.",
      "unfold filter_valid.",
    ...
    "proof_max-header": [
      ...
      "Qed.",
      "",
      "Module Type SigSubProofs.",
      "  Axiom invalid_is_noop_on_main :",
      "    forall storage x,",
      "      valid_op storage x = false -> main_get_storage storage x = storage.",
      "  ",
      "  Axiom main_preserves_invariant_max :",
      "    forall (xarg : param)",
      "         (xstate : storage)",
      "         (xaux : nat)",
      ...
      "End SigSubProofs.",
      "",
      "Module UnitTestMax (SubProofs : SigSubProofs).",
      "",
      "Definition invalid_is_noop_on_main := SubProofs.invalid_is_noop_on_main.",
      "Definition main_preserves_invariant_max := SubProofs.main_preserves_invariant_max.",
      ""
    ],
    "proof_max-reminder": [
      "Print spec_max.",
    ...
    "proof_max-subproofs-intermission": [
      "",
      "End UnitTestMax.",
      "",
      "Module SubProofs <: SigSubProofs.",
      ""
    ],
    "proof_max-invalid_is_noop_on_main-signature": [
      "Theorem invalid_is_noop_on_main :",
      "  forall storage x,",
      "    valid_op storage x = false -> main_get_storage storage x = storage."
    ],
    "proof_max-invalid_is_noop_on_main-proof": [
      "intros s x Hinvalid.",
      "unfold main_get_storage.",
      "unfold main.",
      "case_eq x.",
    ...
    "proof_max-main_preserves_invariant_max": [
    ...
    "proof_max-subproofs-footer": [
      "",
      "End SubProofs.",
      "Module CompletedUnitTestMax := UnitTestMax SubProofs.",
      "Definition unit_test_max := CompletedUnitTestMax.unit_test_max."
    ],
    "extract-definitions": [
      "Require Import List.",
      "Import ListNotations.",
